                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center w-100">
                            ...
                            <div>
                                <a href="<?= url('/app/users/user'); ?>" class="btn btn-pill btn-success"><i
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <form class="form-inline mb-1" action="<?= url('/app/users/home'); ?>" method="post">
                                    ...
                                    <?php if ($users): ?>
                                        <?php foreach ($users as $user): ?>
                                            <tr>
                                                ...
                                                <td><?= $user->email; ?></td>
                                                <td align="center">
                                                    <a href="<?= url('/app/users/user/'.$user->id); ?>"
                                                        class="btn btn-info btn-sm" title="Editar"><i
                                                            class="fa fa-pencil"></i></a>

                                                    <a href="#" class="btn btn-danger btn-sm"
                                                        data-post="<?= url("/app/users/user/{$user->id}"); ?>"
                                                        data-action="delete"
