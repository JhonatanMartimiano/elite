    ...
    <div class="side-app">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= url('/app/users/home'); ?>">Usuários</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card m-b-20">
                    ...
                    <div class="card-body">
                        <form action="<?= url('/app/users/user'); ?>" method="post">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card m-b-20">
                    ...
                    <div class="card-body">
                        <form action="<?= url('/app/users/user/'.$user->id); ?>" method="post">
